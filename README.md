...
2. **采购** — 申请「建筑结构」商业版 → 李明通过 → 李振华通过 → 李振华下单并选对公转账 → 切沈涛确认到账
3. **免费额度** — 申请「屋架桁架」→ 李明 → 李振华 → 沈涛，三级审批后新建席位池

另外两个值得看的点：以李振华身份在成员管理里停用「郑凯」，他的 3 个席位会立即回池；在席位池页面能看到「多高层（商业版）」10 天后到期的续费提醒。
